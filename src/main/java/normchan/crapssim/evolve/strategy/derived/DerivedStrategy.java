package normchan.crapssim.evolve.strategy.derived;
...
/**
 * 
 * boring strategy that the evolution engine came up with as the best.   average balance 4995
 * @author bknapp
 *
 */
@AutoProperty
public class DerivedStrategy extends ProgressiveRollStrategy {
	...
	public int PASS_LINE_ODDS_BET5 = 20;
	public int PASS_LINE_ODDS_BET6 = 15;
	public int PASS_LINE_ODDS_BET8 = 21;
	public int PASS_LINE_ODDS_BET9 = 20;
	public int PASS_LINE_ODDS_BET10 = 15;

	public int BET_COME_AMT_NONE = 0;
	public int BET_COME_AMT_ONE = 0;
	public int BET_COME_AMT_TWO = 0;
	public int BET_COME_AMT_THREE = 0;
	public int BET_COME_AMT_FOUR = 0;
	public int BET_COME_AMT_FIVE = 0;

	public int ODDS_COME4 = 0;
	public int ODDS_COME5 = 0;
	public int ODDS_COME6 = 0;
	public int ODDS_COME8 = 0;
	public int ODDS_COME9 = 0;
	public int ODDS_COME10 =0;
	...
	public DerivedStrategy(GameManager manager) {
		super(manager, 0);
